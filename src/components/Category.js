const Category = () => {
    return ( 
        ...
        <div className=" text-black grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-8 px-5 " >
        
        <div className="bg-gray-100 h-64 w-full rounded-md mt-11 flex justify-center transform hover:scale-105 transition-transform duration-500 ease-in-out   items-center   " > 
        ...
        <div className="bg-gridsecond h-64 w-full rounded-md mt-11 flex justify-center items-center transform hover:scale-105 transition-transform duration-500 ease-in-out   " > 
       ...
       <div className=" flex flex-col items-center text-center p-2  " >
        ...
        <div className=" bg-gray-100 h-64 w-full rounded-md mt-11 flex justify-center items-center transform hover:scale-105 transition-transform duration-500 ease-in-out   " >
