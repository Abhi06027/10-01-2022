...
const Nav2 = () => {
   return (
        ...
        <div className="  h-20 bg-white flex justify-around text-xl lg:xl  w-full text-black   " >
         ...
         <ul className="  space-x-10 items-center cursor-pointer text-lg hidden lg:flex   "   >
        ...
        <input className="  hidden lg:flex   text-xs py-3 pl-4 w-44 border border-gray-300  bottom-2   rounded-full  " type="text" placeholder="Search product" />         
   ...
   <div className=" flex justify-center items-center    "   >
        <div className=" flex justify-center items-center cursor-pointer    bg-white border border-gray-300   lg:h-8 lg:w-8 h-11 w-11  rounded-full   "    >
         
        <svg xmlns="http://www.w3.org/2000/svg" class="lg:h-4 lg:w-4 h-5 w-5 " fill="none" viewBox="0 0 24 24" stroke="currentColor">
 ...
 <div className="  justify-center items-center hidden lg:flex   "   >
        <div className=" flex justify-center items-center cursor-pointer transform hover:scale-110 transition-transform duration-500 ease-in-out   bg-blue-700 text-white  rounded-full py-2 px-5  hover:bg-red-500 "    >
