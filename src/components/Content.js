...
const Content = () => {
    return (
        ...
        <p className=" text-black text-lg italic pb-3 md:pb-10    "   > Best Both Collection By 2021!</p> 
        <p className="  bg-blue-500 rounded-full transform hover:scale-110 transition-transform duration-500 ease-in-out   text-white  py-3 w-36   text-center  text-xl hover:bg-red-500   "   >Shop Now</p> 
